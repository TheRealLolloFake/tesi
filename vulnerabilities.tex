	...
	\subsection{Insecure sub-protocol}
	...
	The technical specifications of the legitimate client are not important because it just need to send one message to the server.\\
